...
#     # Various initializations, derived attributes, I/O setup
...
#         # Scale down gradient accumulation steps per process proportionally
...
#     t0 = time.time()
#     local_iter_num = 0  # local iteration counter
#     running_mfu = -1.0
#     while True:
...
#         # Evaluate and checkpoint at evaluation intervals.
...
#         # Forward-backward update with gradient accumulation and automatic mixed precision.
...
#         # Timing and update MFU without printing the loss.
#         t1 = time.time()
#         dt = t1 - t0
#         t0 = t1
...
#             # print(f"[{iter_num}]: time={dt * 1000:.0f}ms, mfu={running_mfu:.2%}")
#         iter_num += 1
#         local_iter_num += 1
